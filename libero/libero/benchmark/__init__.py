...
class Benchmark(abc.ABC):
    ...
    def _make_benchmark(self):
        ...
        if self.name in ("libero_90", "libero_90_subset", "libero_90_subset0", "libero_90_subset0_v2", "libero_90_boost", "libero_90_task14", "libero_90_task39", "libero_90_task77"):
            self.tasks = tasks
        else:
...
@register_benchmark
class LIBERO_90_TASK77(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_90_task77"
        self._make_benchmark()
